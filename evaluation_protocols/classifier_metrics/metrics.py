...
def get_cross_resolution_scores(models_base_path, model, dataset_path, date, template_matching, far=1.e-3):
    """
    ...
    :param dataset_path: data set nema
    ...
    path = os.path.join(models_base_path, model, dataset_path, date, 'scores/scores_cross_correlation')
